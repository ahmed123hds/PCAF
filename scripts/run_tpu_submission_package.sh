...
ABLATIONS="$ROOT_DIR/scripts/run_tpu_iclr_ablation_grid.sh"
AUDIT="$ROOT_DIR/scripts/audit_iclr_results.py"
TABLES="$ROOT_DIR/scripts/make_paper_ready_tables.py"
PYTHON="${PYTHON:-python}"

STAMP="$(date +%Y%m%d_%H%M%S)"
LOG_ROOT="${LOG_ROOT:-$ROOT_DIR/logs/submission_package_${STAMP}}"
mkdir -p "$LOG_ROOT"
