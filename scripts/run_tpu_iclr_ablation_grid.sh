...
SUMMARY="$ROOT_DIR/scripts/summarize_logs.py"
...
# Balanced 41M PCAF default: standard 4x FFN expansion with enough depth
# for full autoregressive modeling. With vocab=32k this is about 41.9M params.
PCAF_D_MODEL="${PCAF_D_MODEL:-224}"
PCAF_D_HIDDEN="${PCAF_D_HIDDEN:-896}"
PCAF_LOCAL_LAYERS="${PCAF_LOCAL_LAYERS:-14}"
...
LOG_DIR="${LOG_DIR:-$ROOT_DIR/logs/tpu_iclr_ablation_${STAMP}}"
mkdir -p "$LOG_DIR"
