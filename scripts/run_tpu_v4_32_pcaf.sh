...
#   gcloud compute tpus tpu-vm ssh TPU_NAME --worker=all --command='cd ~/models/PCAF && bash scripts/run_tpu_v4_32_pcaf.sh'
...
LOG_JSONL="${LOG_JSONL:-logs/jax_tpu_pcaf_seq${SEQ_LEN}.jsonl}"
