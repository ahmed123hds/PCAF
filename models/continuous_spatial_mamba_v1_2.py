...
class ContinuousSpatialSSM_V12(nn.Module):
    ...
    def forward(self, x: torch.Tensor, K_steps: int = 3, use_triton: bool = False) -> torch.Tensor:
        ...
        if use_triton and x.is_cuda:
            ...
            h = cs_mamba_v12_forward_reference(h0, delta_self, delta_diff, A, D_phys, K_steps, H, W)
...
class ContinuousSpatialMambaBlock_V12(nn.Module):
    def __init__(self, d_model: int, expand: int = 2):
        ...
        self.continuous_ssm = ContinuousSpatialSSM_V12(d_model=d_model, expand=expand)
...
class ContinuousSpatialMambaClassifier_V12(nn.Module):
    def __init__(self, cfg):
        ...
        self.blocks = nn.ModuleList([
            ContinuousSpatialMambaBlock_V12(cfg.d_embed)
