...
#
# Override examples:
#   STEPS=1000 ./associative_field_lab/scripts/run_3060_ablation.sh
...
TRAIN="$ROOT_DIR/associative_field_lab/train_lm.py"
LOG_DIR="${LOG_DIR:-$ROOT_DIR/associative_field_lab/logs/rtx3060_$(date +%Y%m%d_%H%M%S)}"
...
"$PYTHON" "$ROOT_DIR/associative_field_lab/scripts/summarize_logs.py" "$LOG_DIR" \
