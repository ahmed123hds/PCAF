...
PCAF is loosely motivated by complementary learning systems accounts of human
memory \citep{mcclelland1995complementary,kumaran2016learning}. These accounts
distinguish rapid storage and retrieval of episodic information from slower
learning of statistical regularities. We use this distinction only as a design
analogy. The associative cache provides a direct retrieval path, the local
parametric model captures reusable regularities, and a learned gate combines
their predictions. We do not claim that these components model specific neural
circuits.
...
On PG-19, PCAF-semantic also improves perplexity over the matched baselines.
...
In these runs, PCAF improves perplexity while processing more tokens per second
than dense or local attention at the same scale.
